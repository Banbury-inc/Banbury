...
interface DropboxCreateMenuProps {
  onCreateDocument: () => void
  onCreateSpreadsheet: () => void
  onCreatePowerpoint: () => void
}

export function DropboxCreateMenu({
  onCreateDocument,
  onCreateSpreadsheet,
  onCreatePowerpoint,
}: DropboxCreateMenuProps) {
  return (
    <Select
      value=""
      onValueChange={(value) => {
        if (value === 'document') onCreateDocument()
        if (value === 'spreadsheet') onCreateSpreadsheet()
        if (value === 'presentation') onCreatePowerpoint()
      }}
    >
