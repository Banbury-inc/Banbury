...
export function TextColorButton({ applyCellStyle, removeCellStyle }: TextColorButtonProps) {
    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent align="start" className="min-w-[220px] p-1">
          ...
          {colors.map((color) => (
            <div
              ...
              onClick={(e: React.MouseEvent<HTMLDivElement>) => { 
                ...
                e.stopPropagation() 
                setIsOpen(false)
                requestAnimationFrame(() => applyCellStyle('color', color)) 
              }}
        ...
        <DropdownMenuItem 
          ...
          onClick={() => { 
            setIsOpen(false)
            setTimeout(() => removeCellStyle('color'), 0) 
          }}
        >
          Clear text color
        </DropdownMenuItem>
