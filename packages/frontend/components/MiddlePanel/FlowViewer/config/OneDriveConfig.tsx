...
import { OneDriveNodeData } from '../nodes/OneDriveNode'

interface Props {
  data: OneDriveNodeData
  onChange: (data: Partial<OneDriveNodeData>) => void
}
...
export function OneDriveConfig({ data, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <Select value={op} onValueChange={val => onChange({ operation: val as OneDriveNodeData['operation'] })}>
