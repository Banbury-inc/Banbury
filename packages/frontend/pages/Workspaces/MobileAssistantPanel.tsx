import { Folder, Mail, Calendar, CheckSquare, Video, UserCog, X, Database, GitBranch, Map } from 'lucide-react'
...
interface MobileAssistantPanelProps {
  ...
  renderAssistantPanelGroup: (group: PanelGroup) => React.ReactNode
}
...
export function MobileAssistantPanel({
  ...
  userInfo,
  assistantDockLayout,
  renderAssistantPanelGroup,
}: MobileAssistantPanelProps) {
  const tabs = [
      ...
      <SheetContent side="right" className="w-full sm:w-[400px] p-0 [&>button]:hidden mobile-sheet-expand-right">
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-hidden">
            <div data-assistant-dock className="h-full relative">
