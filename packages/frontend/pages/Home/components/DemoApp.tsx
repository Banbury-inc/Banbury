...
import { GmailMessage } from '../../../../backend/api/emails/emails'
...
function setupDemoMocks() {
  ...
  ApiService.Files.getUserFiles = async (username: string) => {
    return {
      success: true,
  ...
  // Mock DriveService
  ApiService.Drive.listFiles = async () => {
    return {
  ...
  // Mock EmailService
  ApiService.Emails.listMessages = async () => {
    return {
  ...
  ApiService.Calendar.listEvents = async () => {
    return {
      ...
      <TooltipProvider>
        ...
        <div className="flex-1 h-full min-w-0">
          <MiddlePanel 
            ...
            hasFilesOpen={selectedFile !== null}
          />
        </div>
