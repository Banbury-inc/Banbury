    ...
    <DocPageLayout>
      <Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{
            ...
            <Typography variant="list">
              <li><strong>Records directly from your desktop</strong> — No bot appears in participant lists</li>
              <li><strong>Automatically detects meeting windows</strong> — Works with Zoom, Microsoft Teams, Google Meet, and other platforms</li>
              <li><strong>Provides superior recording quality</strong> — Native desktop recording captures higher quality audio and video</li>
              <li><strong>Maintains privacy</strong> — No bot participant means no confusion or questions from meeting attendees</li>
            </Typography>
          </Box>
          <Typography variant="p" className="mb-2">
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="list">
            <li><strong>Native Performance:</strong> Faster load times and smoother interactions compared to web version</li>
            <li><strong>Offline Capabilities:</strong> Continue working even when internet connectivity is limited</li>
            <li><strong>System Integration:</strong> Better integration with your operating system and native notifications</li>
            <li><strong>Desktop Recording:</strong> Bot-free meeting recordings with superior quality</li>
            <li><strong>Resource Efficiency:</strong> Optimized resource usage for extended usage sessions</li>
          </Typography>
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="list">
            <li><strong>Desktop Recording:</strong> Record meetings without bot participants using Recall AI Desktop SDK</li>
            <li><strong>Native Notifications:</strong> System-level notifications for important updates and alerts</li>
            <li><strong>Keyboard Shortcuts:</strong> Customizable keyboard shortcuts for faster workflows</li>
            <li><strong>Auto-Updates:</strong> Automatic updates to ensure you always have the latest features</li>
            <li><strong>Multi-Window Support:</strong> Open multiple windows for different workspaces or tasks</li>
          </Typography>
        </Box>
