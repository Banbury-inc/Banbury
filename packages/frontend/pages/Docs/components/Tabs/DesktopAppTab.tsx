      ...
      <Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="p" className="mb-2">
            This feature is exclusive to the desktop app and is not available in the web version. For more information about meeting recording capabilities, see the <a href="/docs/meeting-agent-feature" className="underline underline-offset-4">Meetings documentation</a>.
          </Typography>
        </Box>
