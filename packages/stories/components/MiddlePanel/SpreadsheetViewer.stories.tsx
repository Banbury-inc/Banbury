  ...
  decorators: [
    (Story: React.ComponentType) => {
      ...
      useEffect(() => {
        ...
        const originalExportSheetAsXlsx = ApiService.Drive.exportSheetAsXlsx
        ...
        ApiService.Drive.exportSheetAsXlsx = mockExportSheetAsXlsx as any
        ...
        return () => {
          ...
          ApiService.Drive.exportSheetAsXlsx = originalExportSheetAsXlsx
