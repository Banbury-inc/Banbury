...
import { DocumentViewer } from '../../../frontend/components/MiddlePanel/DocumentViewer/DocumentViewer'
import { TiptapAIProvider } from '../../../frontend/contexts/TiptapAIContext'
import { TooltipProvider } from '../../../frontend/components/ui/tooltip'
import { ApiService } from '../../../backend/api/apiService'
import { createStructuredHtmlDiff } from '../../../frontend/utils/htmlDiff'
...
import '../../../frontend/styles/DiffPreview.css'
  ...
  decorators: [
    (Story: React.ComponentType) => {
      ...
      useEffect(() => {
        ...
        const originalExportDocAsDocx = ApiService.Drive.exportDocAsDocx
        const originalUpdateFile = ApiService.Drive.updateFile
        ...
        ApiService.Drive.exportDocAsDocx = mockExportDocAsDocx as any
        ApiService.Drive.updateFile = mockUpdateFile as any
        ...
        return () => {
          ...
          ApiService.Drive.exportDocAsDocx = originalExportDocAsDocx
          ApiService.Drive.updateFile = originalUpdateFile
        }
      }, [])
