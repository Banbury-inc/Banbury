...
export const stagehandCreateSessionTool = tool(
  async (input: { startUrl?: string; modelName?: string }) => {
    ...
    try {
      ...
      const { createStagehandSession } = await import('../../../../../../frontend/pages/api/stagehand/_manager')
...
export const stagehandGotoTool = tool(
  async (input: { url: string }) => {
    ...
    const { getStagehandSession } = await import('../../../../../../frontend/pages/api/stagehand/_manager')
...
export const stagehandCloseTool = tool(
  async () => {
    ...
    const { closeStagehandSession } = await import('../../../../../../frontend/pages/api/stagehand/_manager')
