...
export function MeetingAgentTab({}: MeetingAgentTabProps) {
  ...
  async function loadBotSettings() {
    try {
      setIsLoading(true)
      const settings = await MeetingAgentService.getBotSettings()
  ...
  async function handleRemoveImage() {
    ...
    try {
      ...
      await MeetingAgentService.updateBotSettings({
        botName,
        profilePictureUrl: ''
      })
  ...
  async function handleSave() {
    try {
      ...
      if (selectedFile) {
        const uploadResult = await MeetingAgentService.uploadProfilePicture(selectedFile)
      ...
      const updatedSettings = await MeetingAgentService.getBotSettings()
